...
Se prescribe el uso de **Nginx** como interceptador maestro. En el servidor huésped (Ubuntu), el entorno estático y el entorno dinámico vivirán en directorios separados (`/var/www/miproyecto` y `/var/www/wordpress`). 
...
`ln -s /home/miproyecto-php/htdocs/wordpress /home/miproyecto-php/htdocs/miproyecto.com/public/blog`

Para que el tema diseñado (Child Theme) esté disponible en el CMS, se traza un segundo enlace:
`ln -s /home/miproyecto-php/htdocs/miproyecto.com/src/wp-theme/merci-theme /home/miproyecto-php/htdocs/wordpress/wp-content/themes/merci-theme`
...
`Document Root: /home/miproyecto-php/htdocs/miproyecto.com/public`
...
1. **Bloqueo del Canibalismo de Portada:** En las opciones globales de WordPress, las rutas `siteurl` y `home` se unifican obligatoriamente como `https://miproyecto.com/blog`. No se debe instalar en la raíz ni usar plugins para desviar "la portada de WordPress" a la raíz del dominio principal.
