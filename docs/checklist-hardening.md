# Checklist de Hardening (Endurecimiento) de merci-boilerlate.es
...
- [x] **Principio de Mínimo Privilegio (Usuarios):**
  - Base de datos (`wp_merci-boilerlate_local`): Accedida mediante un usuario de MySQL dedicado (`wp_user_local`), sin privilegios globales.
...
- [x] **Fronteras Inmutables (Nginx):**
  ...
  - WordPress no tiene permisos de escritura sobre la raíz estática (`/var/www/merci-boilerlate/public`).
