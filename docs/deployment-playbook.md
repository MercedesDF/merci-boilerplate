...
2. Descargar y extraer WordPress en una carpeta hermana a la web (`/home/miproyecto-php/htdocs/wordpress`).
...
4. Crear los enlaces simbólicos físicos (Symlinks) para orquestar la arquitectura híbrida:
   - **Puente del CMS:** `ln -s /home/miproyecto-php/htdocs/wordpress /home/miproyecto-php/htdocs/miproyecto.com/public/blog`
   - **Puente del Tema:** `ln -s /home/miproyecto-php/htdocs/miproyecto.com/src/wp-theme/merci-theme /home/miproyecto-php/htdocs/wordpress/wp-content/themes/merci-theme`
   - **Puente de Assets:** `ln -s /home/miproyecto-php/htdocs/miproyecto.com/assets /home/miproyecto-php/htdocs/miproyecto.com/public/assets`
...
2. Configurar la frontera estática: En la pestaña **Settings**, modificar el *Document Root* añadiendo `/public` al final (`/home/miproyecto-php/htdocs/miproyecto.com/public`).
